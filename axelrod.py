...
and global polarization. Journal of Conflict Resolution 41(2), pp. 203-226.

TODO: Step by step visualisation
TODO: Plugin to browser
TODO: Ability to manipulate constants
...
SIZE = 10
NUM_TRAITS = 10
TRAITS = [i for i in range(0, NUM_TRAITS - 1)]
FEATURES = 5
RUNS = 1000
SEED = 1
...
# Helper functions for a square grid
